...
class Plant(Base):
    ...
    management_difficulty: Mapped[ManagementDifficultyEnum] = mapped_column(Enum(ManagementDifficultyEnum, name="management_difficulty", create_type=False))
    ...
    sunlight_requirements: Mapped[SunlightRequirementsEnum] = mapped_column(Enum(SunlightRequirementsEnum, name="sunlight_requirements", create_type=False))
    size: Mapped[SizeEnum] = mapped_column(Enum(SizeEnum, name="plant_size", create_type=False))
    air_purification_effect: Mapped[AirPurificationEnum] = mapped_column(Enum(AirPurificationEnum, name="air_purification", create_type=False))
    pet_stability: Mapped[PetStabilityEnum] = mapped_column(Enum(PetStabilityEnum, name="pet_stability", create_type=False))
